# Contributing to KumuluzEE REST

♥ [KumuluzEE REST](https://github.com/kumuluz/kumuluzee-rest) and want to get involved?
...
**[File a bug report](https://github.com/kumuluz/kumuluzee-rest/issues/)**
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/kumuluzee-rest.git
   # Navigate to the newly cloned directory
   cd html5-boilerplate
   # Assigns the original repo to a remote called "upstream"
   git remote add upstream https://github.com/kumuluz/kumuluzee-rest.git
   ```
